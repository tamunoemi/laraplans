...
namespace Tamunoemi\Laraplans\Traits;
...
trait PlanSubscriber
{
     ...
     *
     * @param  string $name
     * @return \Tamunoemi\Laraplans\Models\PlanSubscription|null
     */
     ...
     * @param string $subscription
     * @param mixed $plan
     * @return \Tamunoemi\Laraplans\Models\PlanSubscription
     */
     ...
     *
     * @param  string $subscription
     * @return \Tamunoemi\Laraplans\SubscriptionUsageManager
     */
